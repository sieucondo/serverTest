...
USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetAllProduct`;
...
-- -----------------------------------------------------
-- procedure GetAllStore
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetAllStore`;

DELIMITER $$
USE `fastorder`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllStore`()
BEGIN
...
-- -----------------------------------------------------
-- procedure GetAllTableKey
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetAllTableKey`;

DELIMITER $$
USE `fastorder`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllTableKey`(
	_TableKey text
)
BEGIN
...
USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetAllUser`;
...
-- -----------------------------------------------------
-- procedure GetBillById
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetBillById`;

DELIMITER $$
USE `fastorder`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetBillById`(
	_Id int
)
BEGIN
	SELECT 
...
-- -----------------------------------------------------
-- procedure GetBillDetailById
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetBillDetailById`;

DELIMITER $$
USE `fastorder`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetBillDetailById`(
	_Id text
)
BEGIN
	SELECT bd.Id, bd.BillId, p.ProductName, bd.Quantity, p.ProductPrice, Price, Total, TableName, DateCreate
...
JOIN (SELECT 
    ...
    (SELECT SUM(price) AS Total FROM billdetail bd 
		WHERE bd.billid = b.Id) AS Total
FROM `bill` b
JOIN `table` t ON t.Id = b.TableId) b ON b.Id = bd.BillId 
where BillId = _Id;
...
-- -----------------------------------------------------
-- procedure GetOrderDetailByOrderId
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetOrderDetailByOrderId`;
...
-- -----------------------------------------------------
-- procedure GetOrderDetailByStoreId
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetOrderDetailByStoreId`;

DELIMITER $$
USE `fastorder`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOrderDetailByStoreId`(
	_StoreId int
)
BEGIN
	SELECT 
...
USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetProductById`;
...
-- -----------------------------------------------------
-- procedure GetProductByType
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetProductByType`;

DELIMITER $$
USE `fastorder`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetProductByType`(
	_Tablekey text,
    _TypeId text
)
BEGIN
...
-- -----------------------------------------------------
-- procedure GetTableStatus
-- -----------------------------------------------------

USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`GetTableStatus`;
...
USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`UpdateStore`;
...
USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`UpdateTable`;
...
USE `fastorder`;
DROP procedure IF EXISTS `fastorder`.`UpdateUser`;
